      ...
      <div className="max-w-container-max mx-auto space-y-section-gap">
        {sections.map((section, index) => (
          <article
            ...
            className={`grid grid-cols-1 md:grid-cols-2 gap-gutter items-center ${index % 2 ? "md:[&>*:first-child]:order-2" : ""}`}
          >
            {section.image && (
            ...
            <div className="flex flex-col justify-center">
              ...
              {section.text && (
                <p className="font-body-md text-body-md text-on-surface-variant mb-stack-lg leading-relaxed whitespace-pre-line">
                  {section.text}
                </p>
              )}
